    ...
    <div className="mt-16 w-full max-w-[1080px] max-md:mt-10 max-md:max-w-full">
      <div className="flex gap-5 max-md:flex-col max-md:gap-8 max-md:px-8">
        ...
        <div className="flex flex-col ml-5 w-[62%] max-md:ml-0 max-md:w-full">
          <form className="flex flex-col w-full text-sm tracking-normal text-black text-opacity-50">
            ...
            <button
              type="submit"
              className="gap-2.5 self-stretch px-2.5 py-5 mt-5 w-full text-white bg-purple-600 rounded-lg min-h-[56px]"
            >
              Sign Up
            </button>
          </form>
